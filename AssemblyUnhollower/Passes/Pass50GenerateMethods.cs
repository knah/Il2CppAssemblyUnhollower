...
namespace AssemblyUnhollower.Passes
{
    public static class Pass50GenerateMethods
    {
        ...
        {
            DoPassOld(context);//todo: replace with new method

        }

        private static void DoPassOld(RewriteGlobalContext context)
        {
        ...
        private static void DoPassNew(RewriteGlobalContext context)
        {
            foreach (var assemblyContext in context.Assemblies)
            {
                foreach (var typeContext in assemblyContext.Types)
