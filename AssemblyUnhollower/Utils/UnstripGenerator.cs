...
namespace AssemblyUnhollower.Utils
{
    public static class UnstripGenerator
    {
        ...
        {
            GenerateInvokerMethodBodyOld(newMethod, delegateField, delegateType, enclosingType, imports);//todo: replace with new method
            //GenerateInvokerMethodBodyNew(newMethod, delegateField, delegateType, enclosingType, imports);
        }

        private static void GenerateInvokerMethodBodyOld(MethodDefinition newMethod, FieldDefinition delegateField, TypeDefinition delegateType, TypeRewriteContext enclosingType, AssemblyKnownImports imports)
        {
        ...
        private static void GenerateInvokerMethodBodyNew(MethodDefinition newMethod, FieldDefinition delegateField, TypeDefinition delegateType, TypeRewriteContext enclosingType, AssemblyKnownImports imports)
        {
            var body = newMethod.Body.GetILProcessor();
