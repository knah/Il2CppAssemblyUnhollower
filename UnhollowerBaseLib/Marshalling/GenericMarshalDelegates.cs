...
namespace UnhollowerBaseLib
{
    ...
    public static class GenericMarshalDelegates<T>
    {
        ...
        public static MethodParameterByRefDelegate MethodParameterByRefRestore;
        ...
        static GenericMarshalDelegates()
        {
            ...
            if (typeof(IIl2CppNonBlittableValueType).IsAssignableFrom(type))
            {
                ...
                MethodParameterByRefRestore = CreateDelegate<MethodParameterByRefDelegate>(GenericMarshallingMethods.MethodParameterByRefRestoreNonBlittalble.MakeGenericMethod(type));
            ...
            if (type.IsInterface || type == typeof(object))
            {
                ...
                MethodParameterByRefRestore = CreateDelegate<MethodParameterByRefDelegate>(GenericMarshallingMethods.MethodParameterByRefRestoreInterface.MakeGenericMethod(type));
            ...
            if (typeof(IIl2CppNullable).IsAssignableFrom(type))
            {
                ...
                MethodParameterByRefRestore = CreateDelegate<MethodParameterByRefDelegate>(GenericMarshallingMethods.MethodParameterByRefRestoreNullable.MakeGenericMethod(type));
            ...
            if (typeof(Il2CppObjectBase).IsAssignableFrom(type))
            {
                ...
                MethodParameterByRefRestore = CreateDelegate<MethodParameterByRefDelegate>(GenericMarshallingMethods.MethodParameterByRefRestoreReference.MakeGenericMethod(type));
            ...
            MethodParameterByRefRestore = CreateDelegate<MethodParameterByRefDelegate>(GenericMarshallingMethods.MethodParameterByRefRestoreBlittalble.MakeGenericMethod(type));
        }
