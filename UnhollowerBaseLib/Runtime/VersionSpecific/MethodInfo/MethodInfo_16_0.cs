...
namespace UnhollowerBaseLib.Runtime.VersionSpecific.MethodInfo
{
    ...
    public unsafe class NativeMethodInfoStructHandler_16_0 : INativeMethodInfoStructHandler
    {
        ...
        {
            if (index < ((Il2CppMethodInfo_16_0*)method)->parameters_count)
                return UnityVersionHandler.parameterInfoStructHandler.il2cpp_parameter_get_type((IntPtr)(&(((Il2CppMethodInfo_16_0*)method)->parameters[index])));
            else
                return IntPtr.Zero;
        }
