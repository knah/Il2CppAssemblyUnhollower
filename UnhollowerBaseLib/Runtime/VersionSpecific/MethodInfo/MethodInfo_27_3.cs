...
namespace UnhollowerBaseLib.Runtime.VersionSpecific.MethodInfo
{
    ...
    public unsafe class NativeMethodInfoStructHandler_27_3 : INativeMethodInfoStructHandler
    {
        ...
        {
            if (index < ((Il2CppMethodInfo_27_3*)method)->parameters_count)
                return UnityVersionHandler.parameterInfoStructHandler.il2cpp_parameter_get_type((IntPtr)(&(((Il2CppMethodInfo_27_3*)method)->parameters[index])));
            else
                return IntPtr.Zero;
        }
