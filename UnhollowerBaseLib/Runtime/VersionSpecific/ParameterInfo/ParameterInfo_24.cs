...
{
    [ApplicableToUnityVersionsSince("0.0.0")]
    internal class ParameterInfo_24_Handler : INativeParameterInfoStructHandler
    {
        [StructLayout(LayoutKind.Sequential)]
        private unsafe struct Il2CppParameterInfo_24
        {
        ...
        {
            var ptr = (Il2CppParameterInfo_24*) Marshal.AllocHGlobal(Marshal.SizeOf<Il2CppParameterInfo_24>() * paramCount);
        ...
        private unsafe class NativeParamInfoStructWrapper : INativeParameterInfoStruct
        {
            ...
            public Il2CppParameterInfo_24* NativeParameter => (Il2CppParameterInfo_24*)Pointer;
