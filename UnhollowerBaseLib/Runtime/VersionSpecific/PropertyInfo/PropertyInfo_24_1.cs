...
namespace UnhollowerBaseLib.Runtime.VersionSpecific.PropertyInfo
{
    ...
    public unsafe class NativePropertyInfoStructHandler_24_1 : INativePropertyInfoStructHandler
    {
        ...
        public uint il2cpp_property_get_flags(IntPtr prop) => ((Il2CppPropertyInfo_24_1*)prop)->attrs;
        ...
        public IntPtr il2cpp_property_get_type(IntPtr prop)
        {
            return UnityVersionHandler.methodInfoStructHandler.il2cpp_method_get_return_type(il2cpp_property_get_get_method(prop));
        }
