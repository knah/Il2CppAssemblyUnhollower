    ...
    public static class Il2CppTypeOf<T>
    {
        public static Il2CppSystem.Type Type
        {
            get
            {
                ...
                if (classPointer == IntPtr.Zero) throw new ArgumentException($"{typeof(T)} does not have a corresponding IL2CPP class pointer");
                var il2CppType = IL2CPP.il2cpp_class_get_type(classPointer);
                if (il2CppType == IntPtr.Zero) throw new ArgumentException($"{typeof(T)} does not have a corresponding IL2CPP type pointer");
